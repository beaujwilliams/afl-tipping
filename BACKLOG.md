...
| 9 | `BL-033` Payment and onboarding workflow | Initiative | You already manage payment status and next-season interest. | Cleaner conversion from waitlist to invite to paid to active member. Spec: [docs/BL-033-payment-and-onboarding-workflow.md](/Users/beauwilliams/Desktop/afl-tipping/docs/BL-033-payment-and-onboarding-workflow.md) | `Idea` |
